...
// Source of truth for built-in actions: each entry emits the constexpr
// constant and the registry entry. The argument is the persisted name.
...
/// @throws std::logic_error on a hash collision between two action names.
