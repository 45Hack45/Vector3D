...
class Physics {
   ...
   public:
    ...
    void addBody(RigidBody &body);  //TOOD: Refactor addBody to createBody, instead of registering the body create it directly from Physics because it owns the resource
   ...
   private:
    ...
    void spin(double step_size){
        realtime_timer.Spin(m_step_size);
    }
